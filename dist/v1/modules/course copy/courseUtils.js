...
class CourseUtils {
    constructor() {
        ...
        this.getById = (courseId) => __awaiter(this, void 0, void 0, function* () {
            return yield My.first(tables_1.Tables.COURSE, ["id", "title", "description", "isIncludesLiveClass", "category_id", "isFree", "materials", "payment_url", "price", "material_price", "attachment", "status", "created_at", "updated_at", "deleted_at"], "id=?", [courseId]);
        });
        /**
         * Get All Courses
         * @param courseDetails
